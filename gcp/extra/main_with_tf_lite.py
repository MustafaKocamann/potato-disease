...
input_index = None
output_index = None
# Patates hastalık sınıfları - Model bu üç kategoriyi ayırt edebilir
class_names = ["Early Blight", "Late Blight", "Healthy"]

# GCP Bucket adı - Kendi bucket adınızı buraya yazın
BUCKET_NAME = "potato-guard-models"  # TODO: Kendi GCP bucket adınızı girin
